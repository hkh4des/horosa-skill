...
Current public version: `Horosa Skill 0.8.0`
...
| Tool execution | `45 / 45 ok=true` |
| Local memory write | `45 / 45` |
| memory query / show | `45 / 45` |
| report JSON artifact | `45 / 45` |
...
| Release runtime | macOS / Windows `v0.8.0` assets (with ken engines bundled) packaged and verified |
...
- macOS and Windows `v0.8.0` runtime release assets (ken engines bundled in)
