...
Current public version: `Horosa Skill 0.6.1`
...
| Release runtime | macOS / Windows `v0.6.1` assets (with ken engines bundled) packaged and verified |
...
- macOS and Windows `v0.6.1` runtime release assets (ken engines bundled in)
