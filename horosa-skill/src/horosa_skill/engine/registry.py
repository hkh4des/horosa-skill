...
TOOL_DEFINITIONS: dict[str, ToolDefinition] = {
    ...
    "liureng_gods": ToolDefinition("liureng_gods", "cn", "liureng_gods", "/liureng/gods", LiuRengGodsInput, "Generate LiuReng gods output.", execution="local"),
    "liureng_runyear": ToolDefinition("liureng_runyear", "cn", "liureng_runyear", "/liureng/runyear", LiuRengRunYearInput, "Generate LiuReng runyear output.", execution="local"),
